...
| 050 | reconcile_deploy_20260923 | 2026-09-23 | Recover all local work, reconcile shipped source, validate and deploy each ready surface. Original path: `docs/plans/plan-050-reconcile-deploy-20260923.md`. | partial (6/7) — ready extension/site channels live; Sidecar source matches live; CWS accepted. Authenticated rollout/backend validation and unsafe recovery work remain gated; see final reconciliation ledger. |
...
| #184      | Checkpoint Progress Notes (CPN)       | **025** ✅, **031** ✅ | completed     |
| #225      | Persistent Focuses                    | unassigned                         | —            |
| #226      | Focus Auto-Resume & Queue             | **031** ✅                   | completed     |
| #227      | Asana Task ↔ Focus Linking           | **018** partial              | partial       |
