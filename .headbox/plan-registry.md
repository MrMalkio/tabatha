...
| 037 | time_editing | 2026-05-29 | Focus Time Editing — time-edit handlers + checkpoint timeline edit mode in focusService/FocusBar. Target v6.1.0–6.3.0 | completed — Phase 1 (v6.1.0): ADJUST_FOCUS_TIME/SET_FOCUS_ELAPSED/REMOVE_LAST_PAUSE. Phase 2 (v6.3.0): ✏️ Edit-mode toggle, per-entry note edit (EDIT_CHECKPOINT), delete (DELETE_CHECKPOINT), add note, clearer time UI. 9 regression tests green, in live dist |
