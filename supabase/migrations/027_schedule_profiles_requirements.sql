-- ============================================================
-- Tabatha Migration 027 — Work Schedule + Work Profiles + Required Hours
...
--
-- RLS consumes migration 026's (org_admin_helpers) SECURITY DEFINER helpers:
...
--
-- RPCs follow the 020/026 hardening precedent: SECURITY DEFINER,
...
-- Run order: after 026 (org_admin_helpers). DO NOT APPLY before 026 is on prod.
-- ============================================================
