...
- **Current focus:** Cortex program (Plans 039/040–044). Phase 1 browser-regression-verified; Phases 2–5 partial (companion capture built on tabatha-desktop feat/cortex-capture; voice v0 + self-correction shipped). Awaiting Malkio: extension RELOAD + re-smoke-test → v7.0.0, companion merge/deploy, proxy secret. See `docs/cortex/HANDOFF.md`.
